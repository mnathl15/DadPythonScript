...
page = urllib.request.urlopen("C:/Users/thele/PycharmProjects/History_Project/History.html").read()

soup = BeautifulSoup(page,"html.parser")

links = soup.find_all("tbody",class_="job")

num_jobs = int(soup.find("span",class_="legend work").get_text())
conf_nums =soup.find_all("span",class_="confNum")
...
workbook = xlsxwriter.Workbook('C:/Users/Andrew/Desktop/History_Project/ScheduleHistory.xlsx')
...
for i in range(1,num_jobs+1):
    ...
    worksheet.write(i,7,conf_nums[i].get_text())
